  ...
  onClick = async (id, value) => {
    ...
    contract.methods
      ...
      .send({
        ...
        gasLimit: this.state.web3.eth.getBlock("latest").gasLimit,
          ...
          <TableBody>
            {this.state.betdetails.map((row) => (
              ...
              >
                ...
                <TableCell>{this.state.web3.utils.fromWei(row.price, "ether")}</TableCell>
                <TableCell>
                  {row.challenger != this.state.account ? (
                    <Button
                      ...
                      onClick={() =>
                        this.onClick(
                          row.id,
                          this.state.web3.utils.fromWei(row.price, "ether")
                        )
                      }
                    >
                      join
