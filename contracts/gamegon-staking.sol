...
contract BetList  {
  ...
  // Publish a new bet
  function publishBet(string _name, string _conditions) payable public {
  ...
  function resolveBet(uint _id, bool challengerWins ) payable public {
    // Retrieve the bet
    Bet storage bet = bets[_id];
  ...
  function terminate() payable public {
